...
export const ArrowCTA = ({ color }: IArrow) => {
  return (
    <div className="group-hover:transform group-hover:rotate-45 group-hover:translate-y-[5px] relative inline-flex items-center  transition-all duration-500 ease-in-out ">
      <svg
        width="29"
        height="30"
        viewBox="0 0 29 30"
